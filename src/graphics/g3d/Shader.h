...
class Shader{
	...
	virtual int compareTo (const Shader& other) = 0; // TODO: probably better to add some weight value to sort on
	...
	virtual bool canRender (const Renderable& instance) = 0;
	 ...
	 *           method. */
	virtual void begin (const Camera& camera,const RenderContext& context) = 0;
