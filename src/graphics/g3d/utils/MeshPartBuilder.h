...
public:
	...
	virtual void line (short index1, short index2) = 0;

	/** Add a line. Requires GL_LINES primitive type. */
	virtual void line (VertexInfo p1, VertexInfo p2) = 0;

	/** Add a line. Requires GL_LINES primitive type. */
	virtual void line (const Vector3& p1, const Vector3& p2) = 0;

	/** Add a line. Requires GL_LINES primitive type. */
	virtual void line (float x1, float y1, float z1, float x2, float y2, float z2) = 0;

	/** Add a line. Requires GL_LINES primitive type. */
	virtual void line (const Vector3& p1, Color c1, const Vector3& p2, Color c2) = 0;

	/** Add a triangle by indices. Requires GL_POINTS, GL_LINES or GL_TRIANGLES primitive type. */
	virtual void triangle (short index1, short index2, short index3) = 0;

	/** Add a triangle. Requires GL_POINTS, GL_LINES or GL_TRIANGLES primitive type. */
	virtual void triangle (VertexInfo p1, VertexInfo p2, VertexInfo p3) = 0;

	/** Add a triangle. Requires GL_POINTS, GL_LINES or GL_TRIANGLES primitive type. */
	virtual void triangle (const Vector3& p1, const Vector3& p2, const Vector3& p3) = 0;

	/** Add a triangle. Requires GL_POINTS, GL_LINES or GL_TRIANGLES primitive type. */
	virtual void triangle (const Vector3& p1, Color c1, const Vector3& p2, Color c2, const Vector3& p3, Color c3) = 0;

	/** Add a rectangle by indices. Requires GL_POINTS, GL_LINES or GL_TRIANGLES primitive type. */
	virtual void rect (short corner00, short corner10, short corner11, short corner01) = 0;

	/** Add a rectangle. Requires GL_POINTS, GL_LINES or GL_TRIANGLES primitive type. */
	virtual void rect (VertexInfo corner00, VertexInfo corner10, VertexInfo corner11, VertexInfo corner01) = 0;

	/** Add a rectangle. Requires GL_POINTS, GL_LINES or GL_TRIANGLES primitive type. */
	virtual void rect (const Vector3& corner00, const Vector3& corner10, const Vector3& corner11, const Vector3& corner01, const Vector3& normal) = 0;

	/** Add a rectangle Requires GL_POINTS, GL_LINES or GL_TRIANGLES primitive type. */
	virtual void rect (float x00, float y00, float z00, float x10, float y10, float z10, float x11, float y11, float z11,
		float x01, float y01, float z01, float normalX, float normalY, float normalZ) = 0;
	...
	virtual void addMesh (MeshPart meshpart) = 0;
	...
	virtual void addMesh (Mesh mesh, int indexOffset, int numIndices) = 0;
	 ...
	 * {@link #addMesh(const std::vector<float>&, const std::vector<short>&, int, int)} method instead.
	...
	void addMesh (const std::vector<float>& vertices, const std::vector<short>& indices);
	...
	void addMesh (const std::vector<float>& vertices, const std::vector<short>& indices, int indexOffset, int numIndices);
