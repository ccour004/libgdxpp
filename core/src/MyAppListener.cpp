#include "MyAppListener.h"
    ...
    void MyAppListener::buildProj(float near,float far,float fov,float aspect){
    ...
    void MyAppListener::buildView(Vector3& eye,Vector3& target,Vector3& up){
